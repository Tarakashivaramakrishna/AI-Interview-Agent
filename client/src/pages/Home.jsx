...
const Home = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#f3f3f3] flex flex-col">
      <Navbar/>
      <div className="flex-1 px-6 py-28">
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-center mb-6">
            <div className="bg-gray-100 text-gray-600 text-sm px-4 py-2 rounded-full flex items-center gap-2">
                <HiSparkles size={18} className="bg-green-50 text-green-600"/>AI Powered Smart Interview Platform
            </div>
          </div>
            <div className="text-center mb-28">
                <motion.h1 initial ={{opacity:0,y:30}} animate={{opacity:1,y:0}} transition={{duration:0.6}} className='text-3xl md:text-6xl font-semibold leading-tight max-w-4xl mx-auto'>
                  Practice Interview With
                  <span className="relative inline-block">
                    <span className="bg-green-100 text-green-400 px-5 py-1 rounded-full">
                      AI 
                    </span>
                  </span>
                </motion.h1>
                ...
                <div className="flex flex-wrap justify-center gap-4 mt-10">
                  <motion.button onClick={()=>{
                    ...
                    navigate("/interview")
                  }} whileHover={{opacity:0.9,scale:1.09}} whileTap={{opacity:1, scale:0.98}} 
                  className="bg-black text-white px-10 py-3 rounded-full hover:opacity-90 transition shadow-mg">
                    Start Interview
                  </motion.button>
                   <motion.button onClick={()=>{
                    if(!userData)
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-10 mb-28">
              {
                ...
                ${index==2?"rotate-[-3deg]":""}`}>
                  <div className="absolute -top-8 left-1/2 -translate-x-1/2 w-16 h-16 bg-white border-2 
                  border-green-500 text-green-600 rounded-2xl flex items-center justify-center shadow-lg">
                      {item.icon}
                  </div>
